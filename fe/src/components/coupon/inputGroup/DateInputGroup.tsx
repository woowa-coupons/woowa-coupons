...
import { dateInputStyle, inputGroupTitleStyle, inputGroupTopDivStyle } from "./InputGroup.style";
...
export default function DateInputGroup({title, required, value, inputGroupSize, ...props}: Props) {
